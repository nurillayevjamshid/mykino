...
const copy = {
  uz: {
    ...
    menu: "Menyu",
    back: "Orqaga",
    share: "Do'stga ulashish",
    recentSearches: "Oxirgi qidiruvlar",
    categoriesTitle: "Kategoriyalar",
    categoriesEmpty: "Kategoriyalar hali qo'shilmagan.",
    categoryEmpty: "Bu kategoriyada kinolar topilmadi.",
    seriesTitle: "Seriallar",
    seriesEmpty: "Seriallar hali qo'shilmagan.",
    artistsNav: "Qo'shiqchilar",
    playlistNav: "Playlist",
    podcastsNav: "Podcastlar",
    savedNav: "Saqlangan",
    profileShort: "Profil",
    musicBetaNotice: "Musiqa bo'limi beta versiyada ishlayapti",
    musicBetaInfo: "Batafsil ma'lumot",
    musicLoading: "Yuklanmoqda...",
    loadFailed: "Yuklab bo'lmadi",
    checkNetwork: "Tarmoqni tekshiring va qayta urinib ko'ring.",
    retry: "Qayta urinish",
    nothingFound: "Hech narsa topilmadi",
    musicFooterTagline: "Eng sara qo'shiqlar mini-ilovasi",
    podcastCatPlaceholder: "Bu yerda podcast kategoriyalari bo'ladi",
    soonToBeReady: "Yaqinda sozlanadi",
    musicHistoryTitle: "Oxirgi eshitilgan qo'shiqlar",
    musicHistoryEmpty: "Hali eshitilgan qo'shiq yo'q.",
    commentsTitle: "Izohlar",
    commentsEmpty: "Hali izohlar yo'q. Birinchi bo'lib yozing.",
    commentsPlaceholder: "Izoh yozing...",
    resumeFrom: "dan davom etish",
    fifaKicker: "FUTBOL MARKAZI",
    fifaSub: "Kunlik o'yinlar va turnir jadvallari",
    fifaTabMatches: "Kunlik o'yinlar",
    fifaTabGroups: "Turnir jadvali",
    fifaBannerAria: "Futbol ligalari bo'limi",
    adLabel: "REKLAMA",
    adSkip: "Reklamani o'tkazib yuborish",
    adGo: "Reklamaga o'tish",
    expandPlayer: "Kengaytirish",
    queueLabel: "Navbat",
    likeTrack: "Saqlash",
    moreOptions: "Boshqa",
  ...
  ru: {
    ...
    categoriesEmpty: "Категории ещё не добавлены.",
    categoryEmpty: "В этой категории фильмов нет.",
    seriesTitle: "Сериалы",
    seriesEmpty: "Сериалы ещё не добавлены.",
    artistsNav: "Исполнители",
    playlistNav: "Плейлист",
    podcastsNav: "Подкасты",
    savedNav: "Сохранённые",
    profileShort: "Профиль",
    musicBetaNotice: "Раздел музыки работает в бета-версии",
    musicBetaInfo: "Подробнее",
    musicLoading: "Загрузка...",
    loadFailed: "Не удалось загрузить",
    checkNetwork: "Проверьте сеть и попробуйте снова.",
    retry: "Попробовать снова",
    nothingFound: "Ничего не найдено",
    musicFooterTagline: "Мини-приложение лучших песен",
    podcastCatPlaceholder: "Здесь будут категории подкастов",
    soonToBeReady: "Скоро будет готово",
    musicHistoryTitle: "Недавно прослушанные песни",
    musicHistoryEmpty: "Вы ещё не слушали песни.",
    commentsTitle: "Комментарии",
    commentsEmpty: "Комментариев пока нет. Напишите первым.",
    commentsPlaceholder: "Напишите комментарий...",
    resumeFrom: "продолжить с",
    fifaKicker: "ФУТБОЛЬНЫЙ ЦЕНТР",
    fifaSub: "Ежедневные матчи и таблицы",
    fifaTabMatches: "Матчи дня",
    fifaTabGroups: "Турнирная таблица",
    fifaBannerAria: "Раздел футбольных лиг",
    adLabel: "РЕКЛАМА",
    adSkip: "Пропустить рекламу",
    adGo: "Перейти к рекламе",
    expandPlayer: "Развернуть",
    queueLabel: "Очередь",
    likeTrack: "Сохранить",
    moreOptions: "Ещё",
    shuffle: "Перемешать",
  ...
  en: {
    ...
    categoryEmpty: "No movies in this category.",
    seriesTitle: "Series",
    ...
    musicBetaNotice: "The music section is in beta",
    musicBetaInfo: "More info",
    musicLoading: "Loading...",
    loadFailed: "Failed to load",
    checkNetwork: "Check the network and try again.",
    retry: "Retry",
    nothingFound: "Nothing found",
    musicFooterTagline: "Mini app for the best songs",
    podcastCatPlaceholder: "Podcast categories will be here",
    soonToBeReady: "Coming soon",
    musicHistoryTitle: "Recently played songs",
    musicHistoryEmpty: "No songs played yet.",
    commentsTitle: "Comments",
    commentsEmpty: "No comments yet. Be the first.",
    commentsPlaceholder: "Write a comment...",
    resumeFrom: "resume from",
    fifaKicker: "FOOTBALL CENTER",
    fifaSub: "Daily matches and league tables",
    fifaTabMatches: "Daily matches",
    fifaTabGroups: "League table",
    fifaBannerAria: "Football leagues section",
    adLabel: "AD",
    adSkip: "Skip ad",
    adGo: "Go to ad",
    expandPlayer: "Expand",
...
function buildGeneratedPosterDataUrl(movie) {
  const title = String(movie?.title || "NTV").trim();
  ...
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 1080">
      ...
      <text x="74" y="166" fill="#f8d25c" font-size="28" font-family="Inter, Arial, sans-serif" letter-spacing="2">NTV</text>
...
function buildShareUrl(movie) {
  ...
  const text = `🎬 ${title}${metaLine}\n\n🍿 NTV botida bepul tomosha qiling — bir bosish bilan ochiladi 👇`;
...
function applyCopy() {
  ...
  // Atribut tarjimalari: data-i18n-placeholder, data-i18n-aria-label, data-i18n-title
  const attrMap = [
  ...
  attrMap.forEach(([dataAttr, targetAttr]) => {
    document.querySelectorAll(`[${dataAttr}]`).forEach((el) => {
      ...
      if (!key) return;
      el.setAttribute(targetAttr, plainLabel(t(key)));
    });
  });
